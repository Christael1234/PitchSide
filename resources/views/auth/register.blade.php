            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <!-- Profile Image -->
                        <div class="row mb-3">
                            <label for="image_path" class="col-md-4 col-form-label text-md-end">{{ __('Profile Image') }}</label>
                        ...
                        <!-- Instagram Profile -->
                        <div class="row mb-3">
                            <label for="instagram_profile" class="col-md-4 col-form-label text-md-end">{{ __('Instagram Profile') }}</label>

                            <div class="col-md-6">
                                <input id="instagram_profile" type="text" class="form-control @error('instagram_profile') is-invalid @enderror" name="instagram_profile" value="{{ old('instagram_profile') }}">
